...
cl65 -I ..\src -t apple2 -u __EXEHDR__ ..\src\map_00.asm apple2.lib  -o map_00.apple2 -C ..\src\start6000.cfg || exit
...
java -jar C:\jar\AppleCommander.jar -as mono_prodos.dsk data/map.00 bin < map_00.apple2  || exit
